...
A global transformation in rigid Registration can be described by a transformation matrix. This also brings us to the first historical approach to image registration. If you are unsure about why matrices represent transformations we recommend [this video](https://www.youtube.com/watch?v=kYB8IZa5AuE).
